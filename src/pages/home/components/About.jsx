    ...
    <div className="hero min-h-screen ">
      <div className="hero-content flex-col lg:flex-row">
        <div className="lg:w-1/2 relative">
          <img src={person} className="w-3/4 h-[473px] object-cover rounded-lg shadow-2xl" />
          <img src={parts} className="w-1/2 h-[332px] object-cover absolute right-5 top-1/2 rounded-lg border-8 border-white shadow-2xl" />
        </div>
